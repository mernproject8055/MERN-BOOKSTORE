...
const BookCard = ({ book, setBooks }) => {
    ...
    return (
        <>
            ...
            ${isActive ? "border-primary shadow-lg" : "border-base-300"} hover:border-primary shadow-xl`}>
                {/*Top Row*/}
                ...
                <div className="mt-6 flex justify-between items-center">
                    <span className="text-xs text-base-content/60">
                        {formateData(new Date(book.createdAt))}
                    </span>
                    {/*Action Icons*/}
                    <div className="flex items-center gap-4">
                        {/*EDIT*/}
                        <div className="tooltip tooltip-warning" data-tip="Edit book">
                            <Edit2 className="size-4 text-warning hover:scale-110 transition"></Edit2>
                        </div>
                        {/*DELETE*/}
...
<Trash2 className="size-4" />
            ...
            {showModel && (<dialog className="modal modal-open">
                <div className="modal-box">
                    ...
                    <p className="py-4 text-base-content/70">Are you sure you want to delete
                        <span className="font font-semibold text-base-content">
                            {" "}"{book.title}"</span>?<br />This action cannot be undone .
                    </p>
                    <div className="modal-action">
                        <button className="btn btn-ghost" onClick={() =>
                            setShowModel(false)}>Cancel</button>
