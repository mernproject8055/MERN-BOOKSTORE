          ...
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body">
              ...
              <div className="form-control mb-4">
                ...
                <input type="text" placeholder="Book title" className="input input-bordered" 
                value={book.title} onChange={(e)=>
              ...
              <div className="form-control mb-6">
                ...
                value={book.publishYear} onChange={(e)=>
